          ...
          <NavbarBrand>
            <Link href="/">
              <div className="flex items-center gap-1 group relative">
                <Image className="filter group-hover:brightness-100 group-hover:grayscale transition-colors duration-300" src="/logo.png" width={20} height={20} alt="Sakura Animes" />
